...
class ApplyOffersVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "ApplyOffersTableViewCell", for: indexPath) as! ApplyOffersTableViewCell
        ...
        */
        ...
        cell.btnApply.tag = indexPath.row + 10000
        cell.btnApply.addTarget(self, action: #selector(self.onApply(btn:)), for: .touchUpInside)
    ...
    @objc func onApply(btn:UIButton)
    {
